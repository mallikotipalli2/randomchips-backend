...
// CORS configuration - FIXED to include your frontend domains
const corsOptions = {
  origin: [
    "http://localhost:3000",
    "https://randomchips-frontend.vercel.app",  // Your actual frontend URL
...
// Root endpoint to fix "Cannot GET /" error
app.get('/', (req, res) => {
  res.json({
    message: 'RandomChips Backend API v2.0.0',
    status: 'running',
    environment: process.env.NODE_ENV || 'development',
    endpoints: {
      health: '/health',
    ...
    version: '2.0.0',
    documentation: 'https://github.com/mallikotipalli2/randomchips-backend'
  });
});
